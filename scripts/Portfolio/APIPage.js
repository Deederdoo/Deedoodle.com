class APIPage{
    ...
    init(){
        ...
        this.pictureSourceArray.push("../img/portfolio/api/resource.png");
        this.pictureSourceArray.push("../img/portfolio/api/dao_impl.png");
        this.pictureSourceArray.push("../img/portfolio/api/connection.png");
        this.currentPicture.src = this.pictureSourceArray[0];

        //  Text/Description
        document.getElementById("midDesc").innerHTML = DescHelper.apiDesc(this.currentPictureIndex);
    }
